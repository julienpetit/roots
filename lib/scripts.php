...
function roots_scripts() {
  ...
  wp_enqueue_style('roots_bootstrap_responsive', get_template_directory_uri() . '/assets/css/bootstrap-responsive.css', null);
  wp_enqueue_style('roots_app', get_template_directory_uri() . '/assets/css/app.css', false, null);

  wp_enqueue_style('font_google_api', 'http://fonts.googleapis.com/css?family=Clicker+Script|Fjalla+One|Bitter&effect=grass', false, null);
